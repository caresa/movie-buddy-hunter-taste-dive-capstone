                ...
                for (var i in data.Similar.Results) {
                    ...
                    <div class="contain">
                        ...
                        <div class="js-video">
                            ...
                            <iframe width="225" height="127" src="https://www.youtube.com/embed/${data.Similar.Results[i].yID}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </a>
                        </div>
                    </div>
                        `;
